    ...
    <header className="sticky top-0 z-30 border-b border-white/5 bg-background/60 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-3 px-4">
        ...
        <nav className="hidden items-center gap-6 text-sm sm:flex">
          ...
          <Link to="/soul-duel" className="text-muted-foreground transition-colors hover:text-foreground">
            {t("soulDuel")}
          </Link>
          ...
          <Link to="/bleachdle" className="text-muted-foreground transition-colors hover:text-foreground">
            {t("bleachdle")}
          </Link>
          ...
          <Link to="/missions" className="text-muted-foreground transition-colors hover:text-foreground">
            {t("missions")}
          </Link>
