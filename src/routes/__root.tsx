...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bleach Arena — Draft, Quotes & Weekly Leaderboard" },
      {
        name: "description",
        content:
          "Draft your Bleach dream team, guess who said the quote, take the personality quiz, and climb the weekly leaderboard. Bilingual (EN / AR).",
      },
      ...
      { property: "og:title", content: "Bleach Arena" },
      {
        property: "og:description",
        content: "Draft, quotes, quiz, and weekly leaderboard — bilingual (EN / AR).",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Amiri:wght@400;700&family=Cinzel:wght@500;700;900&family=Inter:wght@400;500;600;700;800&family=Cairo:wght@400;600;700;800&display=swap",
      },
    ],
  }),
